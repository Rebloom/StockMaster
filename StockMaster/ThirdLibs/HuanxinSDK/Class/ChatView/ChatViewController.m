...
@interface ChatViewController ()<UITableViewDataSource, UITableViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate, SRRefreshDelegate, IChatManagerDelegate, DXChatBarMoreViewDelegate, DXMessageToolBarDelegate, IDeviceManagerDelegate>
{
...
- (void)viewDidLoad
{
    ...
    [headerView loadComponentsWithTitle:@"客服"];
...
{
    if (_tableView == nil) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 65, self.view.frame.size.width, self.view.frame.size.height - self.chatToolBar.frame.size.height-65) style:UITableViewStylePlain];
...
- (void)showImage:(UIImageView *)avatarImageView{
    ...
    oldframe=[avatarImageView convertRect:CGRectMake(50, 100, screenWidth-100, screenHeight-200) toView:window];
